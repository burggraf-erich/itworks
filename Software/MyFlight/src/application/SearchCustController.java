...
//	    stage.close();
	...
	public void buildData(){        
	    ...
	    try{
	    	...
	    	Statement statement = conn.createStatement();
	    	ResultSet rs = statement.executeQuery("SELECT Kunde_ID, KundeName, KundeVorname, IFNULL(KundeFirmenname,' ' ), KundeAdresse1, KundePLZ, KundenOrt, KundeTelefon, KundeEmail, KundenLand, Kundengruppen_Kundengruppen FROM myflight.kunden " + where);      
	        while((rs != null) && (rs.next())){
	        	
	        	KundenData.add(new Kunden(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getString(6), rs.getString(7), rs.getString(8), rs.getString(9), rs.getString(10), rs.getString(11)));
